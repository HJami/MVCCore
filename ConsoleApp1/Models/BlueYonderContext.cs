    ...
    public partial class BlueYonderContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=tcp:blueyonder-hj.database.windows.net,1433;Initial Catalog=BlueYonder;Persist Security Info=False;User ID=sqladmin;Password=sheida2666C!!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
